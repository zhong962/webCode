...
(function($) {
						...
						if ( !elem.hasClass('visible') ) {
							...
							if ( animationDelay ) {
								setTimeout(function(){
									...
									if(elem.hasClass('num-animated')){
										elem.addClass("number2");
										$('.number2').leoTextAnimate({
													speed:2000,
													delay:1000,
													// autorun:false,
													fixed:[',',':','.','%','k','m','亿','千','瓦'],
										...
										// blum_backgrounds_Kenburns([{src:background,valign:'top'}]);
										$('.bg-image-holder').attr("style",'background-image: url('+ background +'); background-color: rgb(255, 255, 255); background-position: center top; background-size: cover;');
									}
								}, animationDelay);
							} else {
								elem.addClass( animation + " visible" );
	...
	function blum_backgrounds() {
		...
		if ($body.hasClass('kenburns-background')) {
			...
			var kenburnsBackgrounds = [
				{ src: 'demo/images/image-pg.jpg', valign: 'top' },
				{ src: 'demo/images/image-pg1.jpg', valign: 'top' },
				{ src: 'demo/images/image-pg2.jpg', valign: 'top' }
			];
	...
	// function blum_backgrounds_Kenburns(kenburnsBackgrounds){
	// 	// $('vegas-slide-inner')
	// 	// $('.vegas-slide').remove();

	// 	if ($body.hasClass('kenburns-background')) {
	// 		var kenburnsDisplayBackdrops = true;
	// 		var kenburnsBackgrounds = [
	// 			{ src: 'demo/images/image-pg1.jpg', valign: 'top' },
	// 			{ src: 'demo/images/image-pg.jpg', valign: 'top' },
	// 			{ src: 'demo/images/image-pg1.jpg', valign: 'top' },
	...
	// 					backdrop = backdrops[nb];
	// 					backdrop.animation = 'kenburns';
	// 					backdrop.animationDuration = 2000;
	// 					backdrop.transition = 'fade';
	// 					backdrop.transitionDuration = 1000;
